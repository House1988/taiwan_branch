...
#define DCMONITOR_CLASS            "com/dataeye/DCMonitor"
#define DCEVENT_CLASS              "com/dataeye/DCAgent"
...
void DCJniHelper::setJVM(JavaVM* jvm)
{
	...
	c = env->FindClass(DCMONITOR_CLASS);
	jDCMonitor = (jclass)env->NewGlobalRef(c);
...
void DCJniHelper::globalDeinit()
{
	...
	env->DeleteGlobalRef(jDCMonitor);
	jDCMonitor = NULL;
